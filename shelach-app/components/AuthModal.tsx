...
const GOOGLE_CLIENT_ID = '890845711067-m0kh47pbifka09mv28c1gu3800lst19j.apps.googleusercontent.com';
...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    ...
    const setupGsi = () => {
      ...
      try {
        ...
        // Native Google One Tap prompt on Android
  ...
  const handleGoogleSignIn = () => {
    // Call signInWithPopup synchronously upon tap as fallback
        ...
        <div className="p-6">
          ...
          {tab === 'google' ? (
            <div className="space-y-4 text-center py-2">
              ...
              {/* Native Google Identity Services button container (no popups, no redirects) */}
              <div
                ref={googleBtnRef}
                className="w-full flex justify-center min-h-[44px]"
              />

              {/* Fallback custom button if GSI has not rendered yet */}
              {!gisReady && (
                <button
                  type="button"
